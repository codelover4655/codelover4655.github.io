    ...
    render() {
        ...
        return (
            <>
             ...
             YOU ARE NOT A TUTOR OF THIS DEPARTMENT 
             IF YOU WANT TO BE PLEASE APPLY
             ...
             <div className='contentclass'>
                 ...
                 <img src={this.state.img} alt=" jacket"  height="300px" width="300px"/>
                 <p style={{background:"white",display:"flex"}}> UPDATE IMAGE:  <input type="file"
                   name="image"
                   accept="image/png, image/jpeg,image/jpg"  onChange={(e)=>this.handleImageChange(e)} /></p>
                    ...
                    <input  placeholder='type your updated value here' name="updatedname" onChange={(e)=>this.handleupdatedvalue(e)}/>   
                    <button onClick={()=>this.handleupdate('name',this.state.updatedname)}>SUBMIT</button>
                     </div>
                     <button type="button" onClick={()=>this.toggleclass('class1')}>UPDATE</button>
                    </div>
                    ...
                    <input  placeholder='type your updated value here' name="updatedaboutme" onChange={(e)=>this. handleupdatedvalue(e)}/>
                    <button onClick={()=>this.handleupdate('aboutyou',this.state.updatedaboutme)}>SUBMIT</button>  
                     </div>
                     <button type="button" onClick={()=>this.toggleclass('class2')}>UPDATE</button>
                     </div>
                     ...
                     <input  placeholder='type your updated value here' onChange={(e)=>this.handleupdates(e)}/>
                     <button onClick={()=>this.handleupdates()}>SUBMIT</button>   
                     </div>
                     <button type="button" onClick={()=>this.toggleclass('class3')}>UPDATE</button>
                     </div>
                    ...
                    <input  placeholder='type your updated value here' name='updatedcontact' onChange={(e)=>this.handleupdatedvalue(e)}/>
                    <button onClick={()=>this.handleupdate('contact_no',this.state.updatedcontact)}>SUBMIT</button>   
                    </div>
                    <button type="button" onClick={()=>this.toggleclass('class4')}>UPDATE</button>
                     </div>
